...
- Linting GitHub Action (props [@jeffpaul](https://github.com/jeffpaul) via [#24](https://github.com/10up/Ad-Refresh-Control/pull/24)).
...
[1.0.1]: https://github.com/10up/Ad-Refresh-Control/compare/v1.0.1...1.0.2
